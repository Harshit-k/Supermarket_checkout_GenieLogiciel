...
public class Item {
    ...
    public Item(String id, String name, Category category, double unitPrice, int initialStock) {
        this(id, name, category, unitPrice, 0.0, initialStock);
    }

    public Item(String id, String name, Category category, double unitPrice, double weight, int initialStock) {
    ...
    public double getPrice(int qty) {
        ...
        return category.getEffectivePrice(unitPrice) * qty;
    }
    ...
    public String toString() {
        return String.format("%s - %s (%.2f EUR, stock=%d)", id, name, category.getEffectivePrice(unitPrice), stock);
    }
}
